...
class ImageRecognition:
    ...
    def run_in_local_mode(self):
        ...
        try:
            ...
            detected_emotion = ImageRecognition.EMOTIONS[predictions.argmax()]
        ...
        legs = self.leg_detection.detectMultiScale(self.grey_image,scaleFactor=1.1, minNeighbors=5,minSize=(10,10))
        try:
...
if __name__ == "__main__":
    obj = ImageRecognition(sys.argv[1])
